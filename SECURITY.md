...
Report vulnerabilities through [GitHub private vulnerability reporting](https://github.com/BoraGkc/blogfactory/security/advisories/new). Do not open a public issue with exploit details, credentials, customer data, or tokens. Include the affected version, deployment model, reproduction steps, and impact. We will acknowledge a complete report within seven days.
