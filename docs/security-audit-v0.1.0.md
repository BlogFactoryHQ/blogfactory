...
Until those decisions and the Docker/Railway acceptance runs are complete, keep the repository private, do not push `v0.1.0`, do not publish GHCR images or a Railway badge, and keep the live marketing surface in release-candidate language.
