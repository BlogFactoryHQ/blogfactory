...
Audit date: 2026-08-23. Status: **security and history audit passed; the public release still waits for Railway acceptance.**
...
- `react-router-dom` is pinned to `7.18.2`. Typecheck, 132 web tests, production build, and the runtime audit pass. `npm audit --omit=dev --audit-level=moderate` reports zero vulnerabilities.
