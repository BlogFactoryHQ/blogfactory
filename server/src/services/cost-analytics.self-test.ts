...
const report = buildCostAnalytics({
  logs: [
    ...
    { id: "i1", usageType: "image", postId: "p1", provider: "openrouter-image", modelId: "openrouter/free", status: "success", cost: 0, createdAt: "2026-01-01T00:01:00Z" },
    { id: "i2", usageType: "image", postId: "p2", provider: "google-ai-studio", modelId: "google/test", status: "success", cost: 0.04, createdAt: "2026-01-02T00:00:00Z" },
    { id: "f1", usageType: "image", provider: "openrouter-image", modelId: "openrouter/free", status: "failed", cost: 0, createdAt: "2026-01-02T00:01:00Z" },
  ],
  imageAssets: [
    { type: "cover", sourceKind: "stock", cost: 0 },
    { type: "inline", provider: "google-ai-studio", cost: 0.04 },
  ],
