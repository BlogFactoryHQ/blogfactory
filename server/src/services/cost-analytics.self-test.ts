...
const report = buildCostAnalytics({
  logs: [
    ...
    { id: "i2", usageType: "image", postId: "p2", provider: "openrouter-image", modelId: "x-ai/grok-imagine-image-quality", status: "success", cost: 0.04, createdAt: "2026-01-02T00:00:00Z" },
