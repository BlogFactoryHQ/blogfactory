...
const report = buildCostAnalytics({
  logs: [
    ...
    { id: "i1", usageType: "image", postId: "p1", provider: "openrouter-image", modelId: "openrouter/auto", status: "success", cost: 0, createdAt: "2026-01-01T00:01:00Z" },
    ...
    { id: "f1", usageType: "image", provider: "openrouter-image", modelId: "openrouter/auto", status: "failed", cost: 0, createdAt: "2026-01-02T00:01:00Z" },
  ],
  imageAssets: [
