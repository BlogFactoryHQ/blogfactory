...
export const userSettings = pgTable("user_settings", {
  ...
  imagePlacement: text("image_placement").default("auto"),
  imageCompressionEnabled: boolean("image_compression_enabled").default(true),
  imageSourceMode: text("image_source_mode").default("stock_first"),
  sourceImageAllowed: boolean("source_image_allowed").default(false),
  aiFallbackEnabled: boolean("ai_fallback_enabled").default(true),
  maxAiImagesPerDay: integer("max_ai_images_per_day").default(30),
  maxAiImagesPerPost: integer("max_ai_images_per_post").default(1),
  minMinutesBetweenAiImages: integer("min_minutes_between_ai_images").default(5),
