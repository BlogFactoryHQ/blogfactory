...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 max-w-full items-center justify-center rounded-sm border border-border bg-muted p-1 text-muted-foreground shadow-[inset_0_1px_0_var(--panel-highlight)]",
      className,
    )}
    {...props}
  />
